package org.gyt.thread.problems.deadlock;
...
/**
 * It cannot be assured that this program will lead to a deadlock every time you
 * execute this program. Why? You never know the sequence in which threads
 * execute and the order in which locks are acquired and released. For this
 * reason, such problems are said to be non-deterministic, and such problems
