...
class CounterVarSync {
	public static long count = 0;
}

// This class implements Runnable interface
// Its run method increments the counter three times
class UseCounterVarSync implements Runnable {

	public void increment() {
		// increments the counter and prints the value
		// of the counter shared between threads
		synchronized (this) {
			CounterVarSync.count++;
			System.out.print(CounterVarSync.count + " ");
		}
	}
...
public class DataRaceVarSync {
	public static void main(String args[]) {
		UseCounterVarSync c = new UseCounterVarSync();
