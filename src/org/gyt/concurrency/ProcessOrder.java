...
class ProcessOrder {
	public static void main(String[] args) throws InterruptedException {
		...
		System.out
				.println("Delivery order completed... give it to the customer");
	}
}

// The work could be a Cook, Helper, or Attendant. Though the three work
// independently, the
// should all synchronize their work together to do their part and complete
